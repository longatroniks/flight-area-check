...
export const homePageContent = {
  ...
  errorMessages: {
    failedToLoadLocations: "Failed to load locations. Contact the Maintainer to fire up the API.",
...
export const aboutPageContent = {
  ...
  technologies: {
    ...
    content: "This project utilizes React, TypeScript, Tailwind CSS, and external APIs to gather location-based data.",
  },
};
